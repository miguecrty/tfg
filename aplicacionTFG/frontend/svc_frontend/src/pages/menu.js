    ...
    return (
        ...
        <div className='fondo'>
            ...
            <div className="containerP d-flex flex-wrap justify-content-around mt-4 mb-5">
                ...
                <div  className="bg-white bg-opacity-50 card" onClick={() => handleItemClick('/pronostico')}>
                <h1 className="title text-center mt-4">Pronóstico</h1>
                    <img className="card-img" src="./images/pronostico.png" alt="" />
                </div>
                <div  className="bg-white bg-opacity-50 card" onClick={() => handleItemClick('/micuenta')}>
